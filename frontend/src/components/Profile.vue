                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group" :class="{ 'has-error': passwordChangeFormErrors.newRepeated }">
                                    ...
                                    <div class="col-md-12">
                                        <input type="password" class="form-control"
                                            v-model="passwordChangeForm.newRepeated" />
                                    </div>
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <span v-if="invites.length == 0">
                                    <center><b>- Вы не создавали ещё инвайтов -</b></center>
                                </span>
                                <tbody>
                                    <tr v-for="invite in invites">
                                        <td>
                                            <span class="im-address" v-clipboard="makeLink(invite.invite)"
                                                @success="inviteCopied">{{ invite.invite }}</span>
                                        </td>
                                        ...
                                        <td width="100%">
                                            <div class="pull-right">
                                                ...
                                                <a class="im-button fa fa-clipboard"
                                                    v-clipboard="makeLink(invite.invite)" @success="inviteCopied"></a>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
