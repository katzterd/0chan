<template>
    <div class="profile-page">
        <Headline>
            <span slot="title"> Аккаунт и настройки </span>
        </Headline>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div
                                    ...
                                    :class="{
                                        'has-error':
                                            passwordChangeFormErrors.oldPassword,
                                    }"
                                >
                                ...
                                <div
                                    ...
                                    :class="{
                                        'has-error':
                                            passwordChangeFormErrors.newPassword,
                                    }"
                                >
                                    <label class="control-label col-md-8"
                                        >Новый пароль</label
                                ...
                                <div
                                    ...
                                    :class="{
                                        'has-error':
                                            passwordChangeFormErrors.newRepeated,
                                    }"
                                >
                                    <label class="control-label col-md-8"
                                        >Повтор</label
                                    ...
                                    <div class="col-md-12">
                                        <input
                                            ...
                                            class="form-control"
                                            v-model="
                                                passwordChangeForm.newRepeated
                                            "
                                        />
                                    </div>
                                </div>
                                <ul class="has-error col-md-offset-2">
                                    <li
                                        class="help-block"
                                        v-for="error in passwordChangeFormErrors"
                                    >
                                        {{ error }}
                                    </li>
                                </ul>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <span v-if="invites.length == 0">
                                    <center>
                                        <b>- Вы не создавали ещё инвайтов -</b>
                                    </center>
                                </span>
                                <tbody>
                                    <tr v-for="invite in invites">
                                        <td>
                                            <span
                                                class="im-address"
                                                v-clipboard="
                                                    makeLink(invite.invite)
                                                "
                                                @success="inviteCopied"
                                                >{{ invite.invite }}</span
                                            >
                                        </td>
                                        ...
                                        <td width="100%">
                                            <div class="pull-right">
                                                <span v-if="invite.expired"
                                                    >Истёк</span
                                                >
                                                <span v-if="invite.used"
                                                    >Использован:
                                                    {{ invite.usedBy }}</span
                                                >
                                                <a
                                                    class="im-button fa fa-clipboard"
                                                    v-clipboard="
                                                        makeLink(invite.invite)
                                                    "
                                                    @success="inviteCopied"
...
export default {
    ...
    methods: {
        ...
        saveCss() {
            User.set_style(this.custom_css).then((response) => {
                if (response.data.ok) {
                ...
                if (response.data.ok) {
                    ...
                    if (response.data.result == "limit_exceeded") {
                        this.$bus.emit(
                            ...
                            "Вы исчерпали лимит в 3 инвайта для этого аккаунта, если вы хотите создать больше инвайтов обратитесь к администратору."
                        );
                    }
                }
            });
        ...
        changePassword() {
            ...
            if (
                ...
                this.passwordChangeForm.newRepeated
            ) {
                this.passwordChangeFormErrors.newRepeated =
                    "Пароли не совпадают";
                return;
            }
            User.changePassword(
