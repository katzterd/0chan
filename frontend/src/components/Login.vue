            ...
            <div class="login-form">
                ...
                <div v-else-if="formType == 'register'">
                    <form @submit.prevent="doRegister">
                        <input
                            type="text"
                            :class="{ 'form-error': registerErrors.login }"
                        ...
                        <input
                            type="password"
                            :class="{ 'form-error': registerErrors.password }"
                        ...
                        <input
                            type="password"
                            :class="{ 'form-error': registerErrors.password2 }"
                        ...
                        <ul>
                            <li>
                                Логин используется для входа и не отображается
                                при общении в разделах.
                            </li>
                            <li>
                                При назначении модератором и при владении
                                доской, логин будет виден другим модераторам.
                            </li>
                            <li>
                                В любом случае, стоит придумать новый логин, с
                                которым не связаны другие аккаунты в интернете.
                            </li>
                            <!--<li>-->
                            ...
                            <li>
                                Из-за отсутствия привязки к почте или иным
                                внешним идентификаторам, возможности
                                восстановления аккаунта нет. Введенные данные
                                следует сохранить.
                            </li>
                        </ul>
                        <br />
...
export default {
    ...
    methods: {
        doLogin() {
            ...
            User.login(this.login.login, this.login.password).then(
                (response) => {
