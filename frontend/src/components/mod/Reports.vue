            ...
            <table class="table">
                ...
                <tbody>
                    <tr
                        ...
                        :class="{
                            report: true,
                            'report-post-approved': report.isApproved,
                        }"
                    >
                        <td width="50%">
                            <Post
                                :post="report.post"
                                :thread="{ board: { likes: report.post.likes } }"
                            />
                        </td>
                        <td>
                            <div>
                        ...
                        <td align="right">
                            <div>
                                <button
                                    ...
                                    title="Не принимать больше жалобы на этот пост"
                                    @click.prevent="markApproved(report)"
                                >
                                    <i
                                        v-if="report.isApproved === true"
                                        class="fa fa-fw fa-check-square-o"
                                    ></i>
                                    <i
                                        v-if="report.isApproved === null"
                                        class="fa fa-fw fa-spin fa-spinner"
                                    ></i>
                                    <i
                                        v-if="report.isApproved === false"
