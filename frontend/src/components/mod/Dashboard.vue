<template>
    <div>
        <Headline>
            <span slot="title"
                >Модерация <span v-if="dir">/{{ dir }}/</span></span
            >
        </Headline>
