...
export default {
    ...
    methods: {
        fetch() {
            return Management.moderators(this.dir).then((response) => {
        ...
        addModerator() {
            ...
            Management.addModerator(this.dir, this.newModeratorLogin)
                .then((response) => {
                    if (response.data.ok) {
                        return this.fetch();
