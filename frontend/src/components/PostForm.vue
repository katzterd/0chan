                ...
                if (result.ok) {
                    ...
                    switch (result.reason) {
                        ...
                        case "global_timeout":
                            this.$bus.emit(
                                BusEvents.ALERT_ERROR,
                                "Для предотвращения вайпов, установлен лимит кол-ва тредов в час, ожидайте или запостите в уже существующий тред"
                            );
                            break;
                        ...
                        case "replies_timeout":
                            this.$bus.emit(
                                BusEvents.ALERT_ERROR,
                                "Обнаружен вайп! Постинг заблокирован, ожидайте, в течении 2-х часов постинг будет включен обратно"
                            );
                            break;
                        ...
                        case "registerRequired":
                            this.$bus.emit(
                                BusEvents.ALERT_ERROR,
                                "Чтобы сделать пост или ответить, авторизируйтесь"
                            );
                            break;
                        ...
                        case "tor_disabled":
                            this.$bus.emit(
                                BusEvents.ALERT_ERROR,
                                "Постинг с тор зеркала временно отключен"
                            );
                            break;
                        ...
                        case "spamlist":
                            this.$bus.emit(
                                BusEvents.ALERT_ERROR,
                                "Вы пытаетесь отправить ссылку из спамлиста"
                            );
                            break;
                    }
                } else {
