...
export default {
    ...
    deleteAttachment(attachmentId) {
        return Api.get("moderation/deleteAttachment", {
            params: { attachment: attachmentId },
        });
    },
    restoreAttachment(attachmentId) {
        return Api.get("moderation/restoreAttachment", {
            params: { attachment: attachmentId },
        });
    },
    markNsfwAttachment(attachmentId, isNsfw) {
        return Api.get("moderation/markNsfwAttachment", {
            params: { attachment: attachmentId, isNsfw: isNsfw },
        });
    },

    logs(boardDir, page) {
        return Api.get("moderation/logs", {
            params: { board: boardDir, page: page },
        });
    },
    feed(boardDir, page) {
        return Api.get("moderation/feed", {
            params: { board: boardDir, page: page },
        });
    },
    stats(boardDir) {
    ...
    bans(boardDir, page) {
        return Api.get("moderation/bans", {
            params: { board: boardDir, page: page },
        });
    },
    ...
    markApproved(postId, isApproved) {
        return Api.get("moderation/markApproved", {
            params: { post: postId, isApproved: isApproved },
        });
    },

    lockThread(threadId, isLock) {
        return Api.get("moderation/lockThread", {
            params: { thread: threadId, isLock: isLock },
        });
    },
    pinThread(threadId, isPin) {
        return Api.get("moderation/pinThread", {
            params: { thread: threadId, isPin: isPin },
        });
    },
    unpurgeThread(threadId) {
        return Api.get("moderation/unpurgeThread", {
